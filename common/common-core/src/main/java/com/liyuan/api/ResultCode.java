...
public enum ResultCode implements IResultCode, Serializable {
    ...
    USER_EXISTENCE("A0111", "用户名已存在"),
    PHONE_EXISTENCE("A0111", "手机号已绑定"),
    EMAIL_EXISTENCE("A0111", "邮箱已存在"),
    ...
    Mail_SERVICE_ERROR("C0503", "邮件提醒服务失败"),
    Mail_CheckCode_ERROR("A0132", "邮件校验码输入错"),
